...
def get_database_credentials():
    try:
        ...
        return host, database, user, password, port, blob_url, container_name, resource_group_name, storage_account_name, storage_account_name, storage_connection, subscription_id
